...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
     ...
     [SYMBOL] = LAYOUT(
        KC_TAB,  KC_GRV,  _______, _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
        KC_ESC, _______, _______, _______, _______, _______, _______, _______, KC_SCLN, KC_QUOT,
     ...
     [FUNCTION] = LAYOUT(
        ...
        CSE,     _______, CAD,     RESET,   KC_F6,   KC_F7,   _______, _______, _______, KC_DEL,
           _______, _______, _______, _______,       _______,    _______, _______, _______
     ),
